...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/webpacker/blob/v5.4.2/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/webpacker/tree/v5.4.2" } if s.respond_to? :metadata=
